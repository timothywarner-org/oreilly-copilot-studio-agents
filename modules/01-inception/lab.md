...
**LO1. Required learner artifact:** [agent brief](worksheet.md). **No code required.** The five-minute exercise is a planning task; the instructor demonstrates trial access and agent creation. No account or authoring is required during class.
...
3. **Minute 3-4:** Swap with a partner, or critique your own work. Could another person tell whether the test passed? What request should the assistant decline?
4. **Minute 4-5:** Revise one vague statement. Submit or say your instruction and its test. Keep actual results **NOT RUN** until observed.
...
**Trial access decision:** Which account type is appropriate, what do you do if self-service is blocked, and can the trial publish? Use [the trial walkthrough](../../instructor/01-inception-guide.md) afterward. No administrator approval is expected during class.

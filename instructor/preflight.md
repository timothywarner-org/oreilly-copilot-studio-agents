...
- [ ] Confirm the learner-resource URL with Joan. “Private repo” is not a distribution method.
- [ ] Confirm Joan’s generic title slide and any final resource upload. Her latest agreement covers
      the generic title slide, not an assumption that every other resource was uploaded.
- [ ] Keep the actual presenter invitation outside the repo and visible for the 08:30 production check.
- [ ] Open all four module worksheets and the local fallback demo before teaching.

## Tenant and product

- [ ] Record the actual environment, role, license/credit entitlement, model, and authoring surface
      privately using the evidence template. Do not commit identifying values.
- [ ] Verify standard-harness versus New experience behavior against Microsoft’s creation guidance.
...
- [ ] Prepare anonymized, genuine operational evidence. Do not relabel test-panel results as channel analytics.

## Evidence and recovery

- [ ] Execute E01–E12 against the real configured agent and inspect supporting sources.
...
No script here changes visibility to public. Review rights, source links, history, evidence artifacts,
and learner access first. Private source URLs and instructor notes may require a separate learner package.

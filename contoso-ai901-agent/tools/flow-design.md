...
**Optional advanced follow-up.** The live course uses [GetStudySession](get-study-session.md), with one text input and a fixed 30-minute output. This older multi-day design and its Node reference are retained for independent extension. They are not prerequisites or the core demonstration.

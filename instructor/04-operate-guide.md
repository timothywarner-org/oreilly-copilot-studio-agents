...
**DO:** Answer questions, then point to [native YAML inspection](../contoso-ai901-agent/exports/README.md). Explain that the topic canvas generates YAML and that inspecting a real copy is optional follow-up, not a coding prerequisite. The learner package must contain a genuine sanitized topic capture before advertising that artifact as delivered.

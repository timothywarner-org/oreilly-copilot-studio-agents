...
| [AZ-900 guide](https://learn.microsoft.com/en-us/credentials/certifications/resources/study-guides/az-900) | Current scope includes cloud concepts, architecture and services, management and governance | Preserve official names; do not mislabel the three tool focus codes as exam domains |
...
- **Broad web versus configured website:** Web Search can search beyond configured websites. The core turns it off. The exact AZ-900 guide is deeper than the documented public-source URL allowance. A credentials prefix expands scope and requires testing, not a claim that it isolates the guide. Do not falsely attest ownership.

...
| --- | --- | --- |
| [Approved O’Reilly proposal](https://docs.google.com/document/d/1FbWRkrqNZOhhlR71ru2cRMhenH3UQs-3k3T8zkqOI58/edit) | Exact objectives, AZ-900 assistant scenario, topic coverage, activities | Curriculum-only [excerpt](proposal-curriculum.md); original kept outside Git. |
...
| [AZ-900 study guide](https://learn.microsoft.com/en-us/credentials/certifications/resources/study-guides/az-900) | Assistant subject-matter authority | Use live guide for exam objectives; no exam weights frozen in code. |
